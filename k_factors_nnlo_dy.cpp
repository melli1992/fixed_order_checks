...
double DY_NNLO_BB_expansion(double x, int power){
	...
	if(power==-1){
		return DY_NNLO_BB_full(x)-((alphas_Q*(-((-1 + x)*(2*alphas_Q*CF*pow(-1 + x,4)*(3080 - 7055*x + 7320*pow(x,2) - 3716*pow(x,3) + 749*pow(x,4)) + 9*M_PI*TF*(7759 - 14759*x + 47449*pow(x,2) - 58391*pow(x,3) + 53329*pow(x,4) - 33695*pow(x,5) + 13933*pow(x,6) - 3395*pow(x,7) + 370*pow(x,8)))) + 22680*M_PI*TF*(1 - 2*x + 2*pow(x,2))*log(Q2/muF2) + 45360*M_PI*TF*(1 - 2*x + 2*pow(x,2))*log(1 - x)))/(45360.*pow(M_PI,2)));
	}
	if(power==-2){
		return (alphas_Q*(-((-1 + x)*(2*alphas_Q*CF*pow(-1 + x,4)*(3080 - 7055*x + 7320*pow(x,2) - 3716*pow(x,3) + 749*pow(x,4)) + 9*M_PI*TF*(7759 - 14759*x + 47449*pow(x,2) - 58391*pow(x,3) + 53329*pow(x,4) - 33695*pow(x,5) + 13933*pow(x,6) - 3395*pow(x,7) + 370*pow(x,8)))) + 22680*M_PI*TF*(1 - 2*x + 2*pow(x,2))*log(Q2/muF2) + 45360*M_PI*TF*(1 - 2*x + 2*pow(x,2))*log(1 - x)))/(45360.*pow(M_PI,2));
	}
}
...
double DY_NNLO_qg_expansion(double x, int power){
	...
	if(power==2){
		return (pow(alphas_muR,2)*TF*(1 - x)*(189*CA + 267*CF - 2*(8*CA + 5*CF)*pow(M_PI,2) - 3*beta0*log(muR2/muF2)*(-5 + 2*log(Q2/muF2) + 4*log(1 - x)) + 3*pow(log(Q2/muF2),2)*(4*CA + 3*CF - 4*(CA + 3*CF)*log(1 - x)) + log(Q2/muF2)*(-72*CA - 69*CF + 6*CA*pow(M_PI,2) + 4*CF*pow(M_PI,2) + 12*log(1 - x)*(7*CA + 17*CF - 3*(CA + 3*CF)*log(1 - x))) + log(1 - x)*(-153*CA - 303*CF + 4*(3*CA + 2*CF)*pow(M_PI,2) + log(1 - x)*(96*CA + 273*CF - 2*(13*CA + 35*CF)*log(1 - x))) - 6*(CA + 38*CF)*zeta3))/(24.*pow(M_PI,2));
	}
	if(power==3){
		return (TF*pow(alphas_muR - alphas_muR*x,2)*(-9*(151*CA + 374*CF) + 2*(55*CA + 36*CF)*pow(M_PI,2) + 12*beta0*log(muR2/muF2)*(-5 + 2*log(Q2/muF2) + 4*log(1 - x)) + 6*pow(log(Q2/muF2),2)*(-3*(4*CA + 9*CF) + 8*(CA + 3*CF)*log(1 - x)) - 2*log(Q2/muF2)*(-252*CA - 669*CF + 4*(3*CA + 2*CF)*pow(M_PI,2) + 24*log(1 - x)*(9*CA + 28*CF - 3*(CA + 3*CF)*log(1 - x))) + 2*log(1 - x)*(612*CA + 1713*CF - 8*(3*CA + 2*CF)*pow(M_PI,2) + log(1 - x)*(-3*(86*CA + 261*CF) + 4*(13*CA + 35*CF)*log(1 - x))) + 24*(CA + 38*CF)*zeta3))/(96.*pow(M_PI,2));
	}
	if(power==4){
		return (pow(alphas_muR,2)*TF*pow(1 - x,3)*(1195*CA + 3578*CF - 12*(6*CA + 7*CF)*pow(M_PI,2) + 36*beta0*log(muR2/muF2) + 54*(CA + 3*CF)*pow(log(Q2/muF2),2) + 3*log(1 - x)*(-310*CA - 1033*CF + 36*(4*CA + 9*CF)*log(1 - x)) + 3*log(Q2/muF2)*(-134*CA - 453*CF + 24*(5*CA + 13*CF)*log(1 - x))))/(216.*pow(M_PI,2));
	}
	if(power==5){
		return (pow(alphas_muR,2)*TF*pow(-1 + x,4)*(12305*CA + 10735*CF - 24*(57*CA + 40*CF)*pow(M_PI,2) + 504*beta0*log(muR2/muF2) + 12*(54*(2*CA + 3*CF)*pow(log(Q2/muF2),2) + log(1 - x)*(-5*(100*CA + 223*CF) + 342*(2*CA + 3*CF)*log(1 - x)) + log(Q2/muF2)*(-292*CA - 546*CF + 24*(25*CA + 41*CF)*log(1 - x)))))/(6912.*pow(M_PI,2));
	}
	if(power==6){
		return (pow(alphas_muR,2)*TF*pow(1 - x,5)*(139537*CA + 82187*CF - 200*(113*CA + 56*CF)*pow(M_PI,2) + 6600*beta0*log(muR2/muF2) + 600*(40*CA + 39*CF)*pow(log(Q2/muF2),2) + 80*log(Q2/muF2)*(-164*CA - 261*CF + 30*(51*CA + 61*CF)*log(1 - x)) + 20*log(1 - x)*(348*CA - 601*CF + 30*(226*CA + 255*CF)*log(1 - x))))/(144000.*pow(M_PI,2));
	}
	if(power==7){
		return (pow(alphas_muR,2)*TF*pow(-1 + x,6)*(182023*CA + 101414*CF - 600*(50*CA + 19*CF)*pow(M_PI,2) + 7200*beta0*log(muR2/muF2) + 900*(38*CA + 27*CF)*pow(log(Q2/muF2),2) + 30*log(1 - x)*(2845*CA + 2997*CF + 600*(10*CA + 9*CF)*log(1 - x)) + 60*log(Q2/muF2)*(290*CA + 279*CF + 60*(46*CA + 43*CF)*log(1 - x))))/(216000.*pow(M_PI,2));
	}
	if(power==8){
		return (pow(alphas_muR,2)*TF*pow(1 - x,7)*(64445971*CA + 35468198*CF - 58800*(163*CA + 50*CF)*pow(M_PI,2) + 1940400*beta0*log(muR2/muF2) + 840*(210*(65*CA + 36*CF)*pow(log(Q2/muF2),2) + log(Q2/muF2)*(14968*CA + 13731*CF + 1680*(38*CA + 29*CF)*log(1 - x)) + log(1 - x)*(49480*CA + 51243*CF + 210*(326*CA + 243*CF)*log(1 - x)))))/(7.4088e7*pow(M_PI,2));
	}
	if(power==9){
		return (pow(alphas_muR,2)*TF*pow(-1 + x,8)*(442321415*CA + 236685097*CF - 117600*(499*CA + 128*CF)*pow(M_PI,2) + 10231200*beta0*log(muR2/muF2) + 840*(420*(206*CA + 93*CF)*pow(log(Q2/muF2),2) + 8*log(Q2/muF2)*(15823*CA + 13064*CF + 210*(235*CA + 151*CF)*log(1 - x)) + 3*log(1 - x)*(123244*CA + 119319*CF + 140*(998*CA + 633*CF)*log(1 - x)))))/(4.741632e8*pow(M_PI,2));
	}
	if(power==10){
		return (pow(alphas_muR,2)*TF*pow(1 - x,9)*(6407234287*CA + 3297089125*CF - 1058400*(727*CA + 160*CF)*pow(M_PI,2) + 117482400*beta0*log(muR2/muF2) + 2520*(1260*(308*CA + 117*CF)*pow(log(Q2/muF2),2) + 4*log(Q2/muF2)*(61*(2725*CA + 2031*CF) + 1260*(345*CA + 191*CF)*log(1 - x)) + log(1 - x)*(1817636*CA + 1635115*CF + 1260*(1454*CA + 801*CF)*log(1 - x)))))/(6.4012032e9*pow(M_PI,2));
	}

	if(power==-1){
		return DY_NNLO_qg_full(x)-(pow(alphas_muR,2)*TF*(296352000*pow(1 - x,3)*(1195*CA + 3578*CF - 12*(6*CA + 7*CF)*pow(M_PI,2) + 36*beta0*log(muR2/muF2) + 54*(CA + 3*CF)*pow(log(Q2/muF2),2) + 3*log(1 - x)*(-310*CA - 1033*CF + 36*(4*CA + 9*CF)*log(1 - x)) + 3*log(Q2/muF2)*(-134*CA - 453*CF + 24*(5*CA + 13*CF)*log(1 - x))) + 296352*pow(-1 + x,6)*(182023*CA + 101414*CF - 600*(50*CA + 19*CF)*pow(M_PI,2) + 7200*beta0*log(muR2/muF2) + 900*(38*CA + 27*CF)*pow(log(Q2/muF2),2) + 30*log(1 - x)*(2845*CA + 2997*CF + 600*(10*CA + 9*CF)*log(1 - x)) + 60*log(Q2/muF2)*(290*CA + 279*CF + 60*(46*CA + 43*CF)*log(1 - x))) + 444528*pow(1 - x,5)*(139537*CA + 82187*CF - 200*(113*CA + 56*CF)*pow(M_PI,2) + 6600*beta0*log(muR2/muF2) + 600*(40*CA + 39*CF)*pow(log(Q2/muF2),2) + 80*log(Q2/muF2)*(-164*CA - 261*CF + 30*(51*CA + 61*CF)*log(1 - x)) + 20*log(1 - x)*(348*CA - 601*CF + 30*(226*CA + 255*CF)*log(1 - x))) + 9261000*pow(-1 + x,4)*(12305*CA + 10735*CF - 24*(57*CA + 40*CF)*pow(M_PI,2) + 504*beta0*log(muR2/muF2) + 12*(54*(2*CA + 3*CF)*pow(log(Q2/muF2),2) + log(1 - x)*(-5*(100*CA + 223*CF) + 342*(2*CA + 3*CF)*log(1 - x)) + log(Q2/muF2)*(-292*CA - 546*CF + 24*(25*CA + 41*CF)*log(1 - x)))) + 864*pow(1 - x,7)*(64445971*CA + 35468198*CF - 58800*(163*CA + 50*CF)*pow(M_PI,2) + 1940400*beta0*log(muR2/muF2) + 840*(210*(65*CA + 36*CF)*pow(log(Q2/muF2),2) + log(Q2/muF2)*(14968*CA + 13731*CF + 1680*(38*CA + 29*CF)*log(1 - x)) + log(1 - x)*(49480*CA + 51243*CF + 210*(326*CA + 243*CF)*log(1 - x)))) + 135*pow(-1 + x,8)*(442321415*CA + 236685097*CF - 117600*(499*CA + 128*CF)*pow(M_PI,2) + 10231200*beta0*log(muR2/muF2) + 840*(420*(206*CA + 93*CF)*pow(log(Q2/muF2),2) + 8*log(Q2/muF2)*(15823*CA + 13064*CF + 210*(235*CA + 151*CF)*log(1 - x)) + 3*log(1 - x)*(123244*CA + 119319*CF + 140*(998*CA + 633*CF)*log(1 - x)))) + 10*pow(1 - x,9)*(6407234287*CA + 3297089125*CF - 1058400*(727*CA + 160*CF)*pow(M_PI,2) + 117482400*beta0*log(muR2/muF2) + 2520*(1260*(308*CA + 117*CF)*pow(log(Q2/muF2),2) + 4*log(Q2/muF2)*(61*(2725*CA + 2031*CF) + 1260*(345*CA + 191*CF)*log(1 - x)) + log(1 - x)*(1817636*CA + 1635115*CF + 1260*(1454*CA + 801*CF)*log(1 - x)))) + 2667168000*(1 - x)*(189*CA + 267*CF - 2*(8*CA + 5*CF)*pow(M_PI,2) - 3*beta0*log(muR2/muF2)*(-5 + 2*log(Q2/muF2) + 4*log(1 - x)) + 3*pow(log(Q2/muF2),2)*(4*CA + 3*CF - 4*(CA + 3*CF)*log(1 - x)) + log(Q2/muF2)*(-72*CA - 69*CF + 6*CA*pow(M_PI,2) + 4*CF*pow(M_PI,2) + 12*log(1 - x)*(7*CA + 17*CF - 3*(CA + 3*CF)*log(1 - x))) + log(1 - x)*(-153*CA - 303*CF + 4*(3*CA + 2*CF)*pow(M_PI,2) + log(1 - x)*(96*CA + 273*CF - 2*(13*CA + 35*CF)*log(1 - x))) - 6*(CA + 38*CF)*zeta3) + 1333584000*(-12*CA + 6*CF*(-5 + pow(M_PI,2)) + 3*pow(log(Q2/muF2),2)*(9*CF + 4*(CA + 3*CF)*log(1 - x)) + 2*log(1 - x)*(9*(CA - 7*CF) - 2*(3*CA + 2*CF)*pow(M_PI,2) + 6*beta0*log(muR2/muF2) - 18*CF*log(1 - x) + (13*CA + 35*CF)*pow(log(1 - x),2)) + 2*log(Q2/muF2)*(6*CA - 33*CF - (3*CA + 2*CF)*pow(M_PI,2) + 3*beta0*log(muR2/muF2) + 18*log(1 - x)*(CF + (CA + 3*CF)*log(1 - x))) + 6*(CA + 38*CF)*zeta3) + 666792000*pow(-1 + x,2)*(-9*(151*CA + 374*CF) + 2*(55*CA + 36*CF)*pow(M_PI,2) + 12*beta0*log(muR2/muF2)*(-5 + 2*log(Q2/muF2) + 4*log(1 - x)) + 6*pow(log(Q2/muF2),2)*(-3*(4*CA + 9*CF) + 8*(CA + 3*CF)*log(1 - x)) - 2*log(Q2/muF2)*(-252*CA - 669*CF + 4*(3*CA + 2*CF)*pow(M_PI,2) + 24*log(1 - x)*(9*CA + 28*CF - 3*(CA + 3*CF)*log(1 - x))) + 2*log(1 - x)*(612*CA + 1713*CF - 8*(3*CA + 2*CF)*pow(M_PI,2) + log(1 - x)*(-3*(86*CA + 261*CF) + 4*(13*CA + 35*CF)*log(1 - x))) + 24*(CA + 38*CF)*zeta3)))/(6.4012032e10*pow(M_PI,2));
	}
	if(power==-2){
		return (pow(alphas_muR,2)*TF*(296352000*pow(1 - x,3)*(1195*CA + 3578*CF - 12*(6*CA + 7*CF)*pow(M_PI,2) + 36*beta0*log(muR2/muF2) + 54*(CA + 3*CF)*pow(log(Q2/muF2),2) + 3*log(1 - x)*(-310*CA - 1033*CF + 36*(4*CA + 9*CF)*log(1 - x)) + 3*log(Q2/muF2)*(-134*CA - 453*CF + 24*(5*CA + 13*CF)*log(1 - x))) + 296352*pow(-1 + x,6)*(182023*CA + 101414*CF - 600*(50*CA + 19*CF)*pow(M_PI,2) + 7200*beta0*log(muR2/muF2) + 900*(38*CA + 27*CF)*pow(log(Q2/muF2),2) + 30*log(1 - x)*(2845*CA + 2997*CF + 600*(10*CA + 9*CF)*log(1 - x)) + 60*log(Q2/muF2)*(290*CA + 279*CF + 60*(46*CA + 43*CF)*log(1 - x))) + 444528*pow(1 - x,5)*(139537*CA + 82187*CF - 200*(113*CA + 56*CF)*pow(M_PI,2) + 6600*beta0*log(muR2/muF2) + 600*(40*CA + 39*CF)*pow(log(Q2/muF2),2) + 80*log(Q2/muF2)*(-164*CA - 261*CF + 30*(51*CA + 61*CF)*log(1 - x)) + 20*log(1 - x)*(348*CA - 601*CF + 30*(226*CA + 255*CF)*log(1 - x))) + 9261000*pow(-1 + x,4)*(12305*CA + 10735*CF - 24*(57*CA + 40*CF)*pow(M_PI,2) + 504*beta0*log(muR2/muF2) + 12*(54*(2*CA + 3*CF)*pow(log(Q2/muF2),2) + log(1 - x)*(-5*(100*CA + 223*CF) + 342*(2*CA + 3*CF)*log(1 - x)) + log(Q2/muF2)*(-292*CA - 546*CF + 24*(25*CA + 41*CF)*log(1 - x)))) + 864*pow(1 - x,7)*(64445971*CA + 35468198*CF - 58800*(163*CA + 50*CF)*pow(M_PI,2) + 1940400*beta0*log(muR2/muF2) + 840*(210*(65*CA + 36*CF)*pow(log(Q2/muF2),2) + log(Q2/muF2)*(14968*CA + 13731*CF + 1680*(38*CA + 29*CF)*log(1 - x)) + log(1 - x)*(49480*CA + 51243*CF + 210*(326*CA + 243*CF)*log(1 - x)))) + 135*pow(-1 + x,8)*(442321415*CA + 236685097*CF - 117600*(499*CA + 128*CF)*pow(M_PI,2) + 10231200*beta0*log(muR2/muF2) + 840*(420*(206*CA + 93*CF)*pow(log(Q2/muF2),2) + 8*log(Q2/muF2)*(15823*CA + 13064*CF + 210*(235*CA + 151*CF)*log(1 - x)) + 3*log(1 - x)*(123244*CA + 119319*CF + 140*(998*CA + 633*CF)*log(1 - x)))) + 10*pow(1 - x,9)*(6407234287*CA + 3297089125*CF - 1058400*(727*CA + 160*CF)*pow(M_PI,2) + 117482400*beta0*log(muR2/muF2) + 2520*(1260*(308*CA + 117*CF)*pow(log(Q2/muF2),2) + 4*log(Q2/muF2)*(61*(2725*CA + 2031*CF) + 1260*(345*CA + 191*CF)*log(1 - x)) + log(1 - x)*(1817636*CA + 1635115*CF + 1260*(1454*CA + 801*CF)*log(1 - x)))) + 2667168000*(1 - x)*(189*CA + 267*CF - 2*(8*CA + 5*CF)*pow(M_PI,2) - 3*beta0*log(muR2/muF2)*(-5 + 2*log(Q2/muF2) + 4*log(1 - x)) + 3*pow(log(Q2/muF2),2)*(4*CA + 3*CF - 4*(CA + 3*CF)*log(1 - x)) + log(Q2/muF2)*(-72*CA - 69*CF + 6*CA*pow(M_PI,2) + 4*CF*pow(M_PI,2) + 12*log(1 - x)*(7*CA + 17*CF - 3*(CA + 3*CF)*log(1 - x))) + log(1 - x)*(-153*CA - 303*CF + 4*(3*CA + 2*CF)*pow(M_PI,2) + log(1 - x)*(96*CA + 273*CF - 2*(13*CA + 35*CF)*log(1 - x))) - 6*(CA + 38*CF)*zeta3) + 1333584000*(-12*CA + 6*CF*(-5 + pow(M_PI,2)) + 3*pow(log(Q2/muF2),2)*(9*CF + 4*(CA + 3*CF)*log(1 - x)) + 2*log(1 - x)*(9*(CA - 7*CF) - 2*(3*CA + 2*CF)*pow(M_PI,2) + 6*beta0*log(muR2/muF2) - 18*CF*log(1 - x) + (13*CA + 35*CF)*pow(log(1 - x),2)) + 2*log(Q2/muF2)*(6*CA - 33*CF - (3*CA + 2*CF)*pow(M_PI,2) + 3*beta0*log(muR2/muF2) + 18*log(1 - x)*(CF + (CA + 3*CF)*log(1 - x))) + 6*(CA + 38*CF)*zeta3) + 666792000*pow(-1 + x,2)*(-9*(151*CA + 374*CF) + 2*(55*CA + 36*CF)*pow(M_PI,2) + 12*beta0*log(muR2/muF2)*(-5 + 2*log(Q2/muF2) + 4*log(1 - x)) + 6*pow(log(Q2/muF2),2)*(-3*(4*CA + 9*CF) + 8*(CA + 3*CF)*log(1 - x)) - 2*log(Q2/muF2)*(-252*CA - 669*CF + 4*(3*CA + 2*CF)*pow(M_PI,2) + 24*log(1 - x)*(9*CA + 28*CF - 3*(CA + 3*CF)*log(1 - x))) + 2*log(1 - x)*(612*CA + 1713*CF - 8*(3*CA + 2*CF)*pow(M_PI,2) + log(1 - x)*(-3*(86*CA + 261*CF) + 4*(13*CA + 35*CF)*log(1 - x))) + 24*(CA + 38*CF)*zeta3)))/(6.4012032e10*pow(M_PI,2));
	}
}
