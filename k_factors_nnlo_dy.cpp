...
double vegas_NNLO_qqbar_full(double *k, size_t dim, void *params){
	...
	double jacobian = 1.-tau/z; //needed to transform the boundary dependent terms
	double x = tau/z+k[1]*jacobian;
	return LO_factor()*(NNLO_qqbar_HCF(z)+NNLO_qqbar_HCA(z)+NNLO_qqbar_A2(z)+NNLO_qqbar_B2(z)+2.*(NNLO_qqbar_AC(z)+NNLO_qqbar_BC(z))+NNLO_qqbar_b0_nonconst(z))*(jacobian*pdf_sum_qqbar_charge_weighted(tau/z+k[1]*jacobian,tau/z)/z);
}
