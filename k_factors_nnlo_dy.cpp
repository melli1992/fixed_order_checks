...
if(power==4){
	return (pow(alphas_muR,2)*(CA - 2*CF)*CF*pow(-1 + x,3))/(12.*pow(M_PI,2));
}
if(power==5){
	return (-5*pow(alphas_muR,2)*(CA - 2*CF)*CF*pow(-1 + x,4))/(64.*pow(M_PI,2));
}
if(power==6){
	return (319*pow(alphas_muR,2)*(CA - 2*CF)*CF*pow(-1 + x,5))/(4320.*pow(M_PI,2));
}
if(power==7){
	return (-809*pow(alphas_muR,2)*(CA - 2*CF)*CF*pow(-1 + x,6))/(11520.*pow(M_PI,2));
}
if(power==8){
	return (33823*pow(alphas_muR,2)*(CA - 2*CF)*CF*pow(-1 + x,7))/(504000.*pow(M_PI,2));
}
if(power==9){
	return (-19469*pow(alphas_muR,2)*(CA - 2*CF)*CF*pow(-1 + x,8))/(302400.*pow(M_PI,2));
}
if(power==10){
	return (38257*pow(alphas_muR,2)*(CA - 2*CF)*CF*pow(-1 + x,9))/(617400.*pow(M_PI,2));
}
}
