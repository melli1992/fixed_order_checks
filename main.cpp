...
int main(int argc, char* argv[]){
	...
	//////////////////////////////////////////////
    ofstream output2;
	results outhiggs, higgs1, higgs2;
    outhiggs = call_vegas(init_vegas_higgs("LO"),params);
	cout << "Computing LOtrue" << endl;
	higgs1 = call_vegas(init_vegas_mellin("LOfit"),params);
	cout << "Computing LOfit" << endl;
	CMP = 2.2;
	phiMP = 0.5*M_PI;
	higgs2  = call_vegas(init_vegas_mellin("resum"),params);
    cout << "True (LO):				" << outhiggs.res << " pb +/-" << outhiggs.err <<  endl;
    cout << "Fitted (LO):				" <<  higgs1.res << " pb +/-" << higgs1.err <<  endl;
    cout << "Resummed (LP NLL + NLP LL): 	" << higgs2.res << " pb +/-" << higgs2.err <<  endl;
	output2.open("DY_resummed_fake.out");
